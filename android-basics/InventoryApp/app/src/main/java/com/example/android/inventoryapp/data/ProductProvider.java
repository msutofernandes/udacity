...
public class ProductProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (productQuantity == null) {
            throw new IllegalArgumentException("Please insert quantity");
        }

        byte[] image = values.getAsByteArray(ProductEntry.COLUMN_PRODUCT_PICTURE);
        if (image == null) {
            throw new IllegalArgumentException("Please upload a picture");
        }
    ...
    private int updateProduct (Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_QUANTITY)) {
            Integer count = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_QUANTITY);
